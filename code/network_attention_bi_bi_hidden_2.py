...
logdir = "./tensorboard_logs/attention_bi_bi_hidden_2"
writer = tf.contrib.summary.create_file_writer(logdir)
with writer.as_default():
    tf.contrib.summary.always_record_summaries()
optimizer = tf.train.AdamOptimizer(learning_rate=LEARNING_RATE)
checkpoint_directory = './training_checkpoints/attention_bi_bi_hidden_2'
...
class Encoder(tf.keras.Model):
    ...
    def call(self, init_hidden, encoder_input):
        ...
        predictions, hidden = self.gru(encoder_input, initial_state=init_hidden)
...
if __name__ == "__main__":
    train_network(10, 256, 0.001, 256, './training_checkpoints/attention_bi_bi_hidden')
